...
public class JwtUtils {
    ...
    public JwtUtils(ValidationProperties validationProperties, TokenCipher tokenCipher, TokenRevoker tokenRevoker) {
    ...
    private Key getSigningKey() {
        byte[] keyBytes = Decoders.BASE64.decode(validationProperties.getSecretKey());
    ...
    private String generateToken(String username, String issuerId, String userFingerprintHash) {
        ...
        Algorithm algorithm = HMAC256(validationProperties.getSecretKey());
    ...
    public Boolean validateToken(String authToken, HttpServletRequest request) throws GeneralSecurityException {
        ...
        try {
            ...
            if (userFingerprint != null && userFingerprint.matches("[a-zA-Z0-9]{100}")) {
                ...
                JWTVerifier verifier = require(HMAC256(this.validationProperties.getSecretKey()))
                        .withIssuer(this.validationProperties.getIssuerId())
                        .withClaim("userFingerprint", userFingerprintHash)
                        .build();
    ...
    public String getUsernameFromJwtToken(String token) {
        try {
            ...
            DecodedJWT decodedJWT = JWT.require(Algorithm.HMAC256(validationProperties.getSecretKey()))
                    .withIssuer(validationProperties.getIssuerId())
                    .build()
